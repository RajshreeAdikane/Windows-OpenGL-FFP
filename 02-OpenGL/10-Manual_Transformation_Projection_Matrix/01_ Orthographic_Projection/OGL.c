...
void createOrthographicMatrix(GLfloat* matrix, GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat nearVal, GLfloat farVal);
...
int initialize(void)
{
    ...
    // Initialize orthographic matrix with default values
    createOrthographicMatrix(orthographicMatrix, -100.0f, 100.0f, -100.0f, 100.0f, 0.1f, 100.0f);
...
void resize(int width, int height)
{
    ...
    // Recreate orthographic matrix with new dimensions
    // Using values that will make the triangle visible
    createOrthographicMatrix(orthographicMatrix, -1.0f, 1.0f, -1.0f, 1.0f, -1.0f, 1.0f);

    // Set projection matrix
    glMatrixMode(GL_PROJECTION);
    glLoadMatrixf(orthographicMatrix);
