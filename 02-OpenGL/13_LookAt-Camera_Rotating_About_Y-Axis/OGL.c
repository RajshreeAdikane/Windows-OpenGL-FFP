...
void resize(int width, int height)
{
	...
	void display(void)
	{
		...
		GLfloat cameraX = radius * sinf(angleCube * M_PI / 180.0f);
		GLfloat cameraZ = -12.0f + radius * cosf(angleCube * M_PI / 180.0f);

		// View from the cube, always facing the pyramid at (0, 0, -12)
		gluLookAt(cameraX, 0.0f, cameraZ,   
			0.0f, 0.0f, -12.0f,       
			0.0f, 1.0f, 0.0f);   
		//glTranslatef(0.0f, 0.0f, -5.0f);//cube translation
