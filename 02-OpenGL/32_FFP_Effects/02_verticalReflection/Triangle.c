...
#define MAX_LIMITS_CUBE_TRANSLATE_X 4.0f
#define MIN_LIMITS_CUBE_TRANSLATE_X 0.5f

#define MAX_LIMITS_CUBE_TRANSLATE_Y 8.0f
#define MIN_LIMITS_CUBE_TRANSLATE_Y -8.0f
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT imsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		case VK_DOWN: // -y
			...
			break;
		case VK_OEM_PLUS: // cube away from viewver
			if (translateCubeZ < CLOSEST_LIMIT_CUBE_TRANSLATE_Z)
			{
				translateCubeZ += INCREMENT;
			}
			break;
		case VK_OEM_MINUS: // cube towards viewver
...
void DrawFloor(void)
{
	...
	glRotatef(90.0f, 0.0f, 1.0f, 0.0f); // angle, x, y, z
