...
if (g_iWhichSmiley != 0) {
    ...
    glBindTexture(GL_TEXTURE_2D, 0);
    glDisable(GL_TEXTURE_2D);  // no texture for white rectangle
}
...
if (g_iWhichSmiley == 0)
{
    ...
    // No texcoords needed when texturing is disabled
...
{
    glEnable(GL_TEXTURE_2D); // ensure enabled for other cases
    glColor3f(1.0f, 1.0f, 1.0f); // textured quad should be white to show texture correctly
    ...
    else if (g_iWhichSmiley == 2) {
        glTexCoord2f(1.0f, 0.0f); glVertex3f( 1.0f,  1.0f, 0.0f);
        glTexCoord2f(0.0f, 0.0f); glVertex3f(-1.0f,  1.0f, 0.0f);
        glTexCoord2f(0.0f, 1.0f); glVertex3f(-1.0f, -1.0f, 0.0f);
        glTexCoord2f(1.0f, 1.0f); glVertex3f( 1.0f, -1.0f, 0.0f);
    }
    else if (g_iWhichSmiley == 3) {
    ...
    else if (g_iWhichSmiley == 4) {
        glTexCoord2f(0.55f, 0.55f); glVertex3f( 1.0f,  1.0f, 0.0f);
        glTexCoord2f(0.55f, 0.45f); glVertex3f(-1.0f,  1.0f, 0.0f);
        glTexCoord2f(0.45f, 0.45f); glVertex3f(-1.0f, -1.0f, 0.0f);
        glTexCoord2f(0.45f, 0.55f); glVertex3f( 1.0f, -1.0f, 0.0f);
    }
}
glEnd();
