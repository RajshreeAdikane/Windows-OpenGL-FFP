...
int main(void)
{
    ...
    // changing in X and Y in XCreate window like we didi in windows will not work here because the initial position of the window
    // is governed by window manager so let the window manager decide the poition later we  will centered it by moving XMove wndow XliveAPI
