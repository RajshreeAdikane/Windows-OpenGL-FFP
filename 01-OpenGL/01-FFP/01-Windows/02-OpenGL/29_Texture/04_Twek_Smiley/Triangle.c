...
float lodBias = 0.0f;
int g_g_iWhichSmiley  = 0;
int g_iWhichSmiley  = 0;
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT imsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		case VK_NUMPAD4:
			g_iWhichSmiley = 4;
			break;
		case '0': // Added '0' to show white rectangle (no texture)
		case VK_NUMPAD0:
			g_iWhichSmiley = 0;
			break;
		default:
...
void display(void)
{
    ...
    if (g_iWhichSmiley != 0) // Changed from g_g_iWhichSmiley to g_iWhichSmiley
    ...
    else if (g_iWhichSmiley == 1) // Changed from g_g_iWhichSmiley to g_iWhichSmiley
    {
		// Top-right quarter
    ...
    else if (g_iWhichSmiley == 2) // Changed from g_g_iWhichSmiley to g_iWhichSmiley
    {
		// Full texture
    ...
    else if (g_iWhichSmiley == 3) // Changed from g_g_iWhichSmiley to g_iWhichSmiley
    {
		glTexCoord2f(2.0f, 2.0f); glVertex3f(1.0f, 1.0f, 0.0f);   // Top-right
		glTexCoord2f(0.0f, 2.0f); glVertex3f(-1.0f, 1.0f, 0.0f);  // Top-left
		glTexCoord2f(0.0f, 0.0f); glVertex3f(-1.0f, -1.0f, 0.0f); // Bottom-left
		glTexCoord2f(2.0f, 0.0f); glVertex3f(1.0f, -1.0f, 0.0f);  // Bottom-right
    }

	else if (g_iWhichSmiley == 4) // Ultra-tight yellow center crop
	{
		// Narrowly crop to the innermost yellow (adjust as needed)
		glTexCoord2f(0.45f, 0.55f); glVertex3f(1.0f, 1.0f, 0.0f);   // Top-right
		glTexCoord2f(0.45f, 0.45f); glVertex3f(-1.0f, 1.0f, 0.0f);  // Top-left
		glTexCoord2f(0.55f, 0.45f); glVertex3f(-1.0f, -1.0f, 0.0f); // Bottom-left
		glTexCoord2f(0.55f, 0.55f); glVertex3f(1.0f, -1.0f, 0.0f);  // Bottom-right
	}
