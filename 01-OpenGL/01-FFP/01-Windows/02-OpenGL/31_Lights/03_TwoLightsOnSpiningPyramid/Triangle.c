...
GLfloat lightPosition0[] = { -2.0f, 0.0f, 0.0f, 1.0f };//posiotnal light
...
GLfloat lightPosition1[] = { 2.0f, 0.0f, 0.0f, 1.0f };//posiotnal light
...
void display()
{
	...
	// Front face
	glNormal3f(0.0f, 0.447214f, 0.894428f); // Normal for front face
	glVertex3f(0.0f, 1.0f, 0.0f); // Apex
	glVertex3f(-1.0f, -1.0f, 1.0f); // Bottom left
	glVertex3f(1.0f, -1.0f, 1.0f); // Bottom right

	// Right face
	glNormal3f(0.894428f, 0.447214f, 0.0f); // Normal for right face
	glVertex3f(0.0f, 1.0f, 0.0f); // Apex
	glVertex3f(1.0f, -1.0f, 1.0f); // Bottom right
	glVertex3f(1.0f, -1.0f, -1.0f); // Bottom back right

	// Back face
	glNormal3f(0.0f, 0.447214f, -0.894428f); // Normal for back face
	glVertex3f(0.0f, 1.0f, 0.0f); // Apex
	glVertex3f(1.0f, -1.0f, -1.0f); // Bottom back right
	glVertex3f(-1.0f, -1.0f, -1.0f); // Bottom back left

	// Left face
	glNormal3f(-0.894428f, 0.447214f, 0.0f); // Normal for left face
	glVertex3f(0.0f, 1.0f, 0.0f); // Apex
	glVertex3f(-1.0f, -1.0f, -1.0f); // Bottom back left
	glVertex3f(-1.0f, -1.0f, 1.0f); // Bottom left
